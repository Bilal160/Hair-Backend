...
export class UserAuthController {
  ...
  static async LoginUser(req: Request, res: Response) {
    ...
    try {
      const user = (await AuthService.userByEmailWithPassword(email)) as IUser;
      ...
      const loginResult = await AuthService.loginUser(user, password);
...
static async UpdateUser(req: Request, res: Response) {
  ...
  static async ChangePassword(req: Request, res: Response) {
    ...
    try {
      ...
      const user = await AuthService.changePassword(updatedData);
...
static async forgotPassword(req: Request, res: Response) {
  ...
  static async resetPassword(req: Request, res: Response) {
    ...
    try {
      const verificationCodeData = await AuthService.getVerificationCode(
        verificationCode
      );
  ...
  static async verifyEmail(req: Request, res: Response) {
    ...
    try {
      ...
      const verificationCodeData = await AuthService.getEmailVerificationCode(verificationCode);
      if (!verificationCodeData) {
      ...
      // verify user
      const updatedUser = await AuthService.verifyUser({ userId: userId });
